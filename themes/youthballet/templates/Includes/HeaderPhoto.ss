<% if $BackgroundPhoto %>
	...
	<img src="{$ThemeDir}/images/youth-ballet-logo.png" alt="Youth Ballet">
		...
		<picture>
			...
			<source srcset="$BackgroundPhoto.CroppedFocusedImage(768,500).URL" media="(min-width: 480px)">
			<!--[if IE 9]></video><![endif]-->
...
<% else %>
	<div class="page-photo">
		<picture>
			<!--[if IE 9]><video style="display: none;"><![endif]-->
			<source srcset="$SiteConfig.DefaultPhoto.CroppedFocusedImage(1200,600).URL" media="(min-width: 980px)">
			<source srcset="$SiteConfig.DefaultPhoto.CroppedFocusedImage(980,600).URL" media="(min-width: 768px)">
			<source srcset="$SiteConfig.DefaultPhoto.CroppedFocusedImage(768,500).URL" media="(min-width: 480px)">
			<!--[if IE 9]></video><![endif]-->
